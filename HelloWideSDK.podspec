...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "HelloWideSDK for iOS"
  spec.description  = <<-DESC
  HelloWideSDK is is a WebRTC compatible, free and Open Source video conferencing system that provides browsers and mobile applications with Real Time Communications capabilities.
                   DESC
  spec.homepage     = "https://github.com/ardywijaya/HelloWideSDK"
  spec.license      = 'MIT'
