...
@interface HelloWideConferenceOptionsBuilder : NSObject
...
@interface HelloWideConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(HelloWideConferenceOptionsBuilder *_Nonnull))initBlock;
