...
#ifndef HELLOWIDESDK_SWIFT_H
#define HELLOWIDESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HelloWideSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP12HelloWideSDK17JMCallKitListener_")
...
SWIFT_CLASS("_TtC12HelloWideSDK14JMCallKitProxy")
