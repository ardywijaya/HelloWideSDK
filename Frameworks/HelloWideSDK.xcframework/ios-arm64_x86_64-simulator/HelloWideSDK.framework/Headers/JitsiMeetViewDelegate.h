...
@protocol HelloWideViewDelegate <NSObject>
...
/**
 * Called when snapshot taken.
 *
 * @param data Map with a "url" key with the conference URL.
 */
- (void)snapshotTaken:(NSDictionary *)data;

/**
 * Called when you are the only one in the meeting.
 *
 * @param data Map with a "url" key with the conference URL.
 */
- (void)iAmLonely:(NSDictionary *)data;
@end
