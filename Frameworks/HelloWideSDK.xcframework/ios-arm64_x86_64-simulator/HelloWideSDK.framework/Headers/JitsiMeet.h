 ...
 */
@property (nonatomic, nullable) HelloWideConferenceOptions *defaultConferenceOptions;
...
- (HelloWideConferenceOptions *_Nonnull)getInitialConferenceOptions;
